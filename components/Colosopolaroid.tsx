...
const ColosoPolaroid = () => {
  return (
    <div className="flex flex-col items-center justify-between w-full">
      ...
      <div className="font-marydale flex flex-row gap-x-5 pr-3 mx-auto text-base bg-background py-1 md:py-2 pt-3 md:pt-4 rounded-b-3xl items-center justify-center">
        {[
